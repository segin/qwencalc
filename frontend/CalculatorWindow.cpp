...
void CalculatorWindow::setupShortcuts() {
    ...
    new QShortcut(QKeySequence("0"), this, this, [this]() {
        currentExpression += "0";
        updateDisplay();
    });
    new QShortcut(QKeySequence("1"), this, this, [this]() {
        currentExpression += "1";
        updateDisplay();
    });
    new QShortcut(QKeySequence("2"), this, this, [this]() {
        currentExpression += "2";
        updateDisplay();
    });
    new QShortcut(QKeySequence("3"), this, this, [this]() {
        currentExpression += "3";
        updateDisplay();
    });
    new QShortcut(QKeySequence("4"), this, this, [this]() {
        currentExpression += "4";
        updateDisplay();
    });
    new QShortcut(QKeySequence("5"), this, this, [this]() {
        currentExpression += "5";
        updateDisplay();
    });
    new QShortcut(QKeySequence("6"), this, this, [this]() {
        currentExpression += "6";
        updateDisplay();
    });
    new QShortcut(QKeySequence("7"), this, this, [this]() {
        currentExpression += "7";
        updateDisplay();
    });
    new QShortcut(QKeySequence("8"), this, this, [this]() {
        currentExpression += "8";
        updateDisplay();
    });
    new QShortcut(QKeySequence("9"), this, this, [this]() {
        currentExpression += "9";
        updateDisplay();
    });

    // Operators
    new QShortcut(QKeySequence("+"), this, this, [this]() {
        currentExpression += "+";
        updateDisplay();
    });
    new QShortcut(QKeySequence("-"), this, this, [this]() {
    ...
    // Equals
    new QShortcut(QKeySequence("Enter"), this, this,
                  &CalculatorWindow::onEqualsClicked);
    new QShortcut(QKeySequence("="), this, this,
                  &CalculatorWindow::onEqualsClicked);

    // Backspace and Clear
    new QShortcut(QKeySequence("Backspace"), this, this,
                  &CalculatorWindow::onBackspaceClicked);
    new QShortcut(QKeySequence("Escape"), this, this,
                  &CalculatorWindow::onClearClicked);
...
void CalculatorWindow::setupUI() {
    ...
    memoryLabelWidget->setStyleSheet(
        "QLabel { color: #ff9800; font-weight: bold; font-size: 14px; }");
...
void CalculatorWindow::setupConnections() {
    connect(keypad, &KeypadWidget::numberClicked, this,
            &CalculatorWindow::onNumberClicked);
    connect(keypad, &KeypadWidget::operatorClicked, this,
            &CalculatorWindow::onOperatorClicked);
    connect(keypad, &KeypadWidget::functionClicked, this,
            &CalculatorWindow::onFunctionClicked);
    connect(keypad, &KeypadWidget::clearClicked, this,
            &CalculatorWindow::onClearClicked);
    connect(keypad, &KeypadWidget::backspaceClicked, this,
            &CalculatorWindow::onBackspaceClicked);
    connect(keypad, &KeypadWidget::equalsClicked, this,
            &CalculatorWindow::onEqualsClicked);
    connect(keypad, &KeypadWidget::memoryClicked, this,
    ...
    connect(keypad, &KeypadWidget::parenClicked, this,
            &CalculatorWindow::onParenClicked);
    connect(keypad, &KeypadWidget::historyToggled, this,
            &CalculatorWindow::onHistoryToggled);
    connect(keypad, &KeypadWidget::themeToggled, this,
            &CalculatorWindow::onThemeChanged);
...
void CalculatorWindow::applyTheme(const QString &themeName) {
    if (themeName == "dark") {
        setStyleSheet(
            ...
            "QLineEdit { background-color: #2d2d2d; color: white; padding: "
            "5px; font-size: 16px; border: 1px solid #444; }\n"
            "QPushButton { background-color: #3a3a3a; color: white; padding: "
            "10px; border-radius: 5px; }\n"
            "QPushButton:hover { background-color: #4a4a4a; }\n"
            "QPushButton:pressed { background-color: #2a2a2a; }\n"
            "QTextEdit { background-color: #2d2d2d; color: #d4d4d4; }\n"
            "QScrollBar:vertical { background-color: #1e1e1e; border: 1px "
            "solid #444; }\n"
            "QScrollBar::handle:vertical { background-color: #555; "
            "border-radius: 2px; }\n"
        ...
        setStyleSheet(
            ...
            "QLineEdit { background-color: white; color: black; padding: 5px; "
            "font-size: 16px; border: 1px solid #ccc; }\n"
            "QPushButton { background-color: #4CAF50; color: white; padding: "
            "10px; border-radius: 5px; }\n"
            "QPushButton:hover { background-color: #45a049; }\n"
            "QPushButton:pressed { background-color: #3d8b40; }\n"
            "QTextEdit { background-color: #f5f5f5; color: black; }\n"
            "QScrollBar:vertical { background-color: white; border: 1px solid "
            "#ccc; }\n"
            "QScrollBar::handle:vertical { background-color: #ccc; "
            "border-radius: 2px; }\n"
            "QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { "
            "height: 10px; }\n");
    }
...
ThemeManager &CalculatorWindow::getTheme() { return themeManager; }
...
void CalculatorWindow::onBackspaceClicked() {
    if (!currentExpression.isEmpty()) {
        ...
        display->displayResult(
            QString::fromUtf8(currentExpression.toStdString().c_str()));
    }
}
...
void CalculatorWindow::onMemoryAdd() {
    try {
        ...
        currentMemoryDisplay =
            QString("M = %1").arg(engine.getMemory(), 0, 'f', 2);
...
void CalculatorWindow::onThemeChanged() {
    QString current = themeManager.getCurrentTheme();
    if (current == "dark") {
        applyTheme("light");
...
void CalculatorWindow::updateHistory() {
    ...
    while ((pos = history.find('\n', start)) != std::string::npos) {
        ...
        if (equalPos > 0) {
            QString expression =
                QString::fromStdString(line.substr(0, equalPos));
            QString result = QString::fromStdString(line.substr(equalPos + 1));
            formattedHistory +=
                QString("<div style='color: #d4d4d4; margin: 2px;'>%1 = <span "
                        "style='color: #4CAF50;'>%2</span></div>")
                    .arg(expression)
                    .arg(result);
        }
    }
